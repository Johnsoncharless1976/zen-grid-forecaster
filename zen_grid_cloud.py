...
def main():
    ...
    st.markdown("*SPX 0DTE Specialization - Deployed on Streamlit Cloud*")
    ...
    # Footer
    st.markdown("---")
    st.markdown("🎯 **Zen Council Market Forecaster** | Live Production Dashboard")
